            ...
            Response.Listener { response -> // response
                ...
                try {
                    ...
                    equipmentList.forEach { e ->
                        ...
                        if (!found) {
                            val newEquipmentCrew:EquipmentCrew = EquipmentCrew(e.crewName, e.crewColor )
                    ...
                    equipmentCrewAdapter = EquipmentCrewAdapter(equipmentCrewList, this.myView.context, this@DepartmentsFragment)
                    println(departmentAdapter.itemCount)

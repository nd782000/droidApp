 ...
 */
class LeadFragment : Fragment(), StackDelegate {
    ...
    override fun onCreateView(
       ...
       // return inflater.inflate(R.layout.fragment_lead, container, false)
        ...
        ((activity as AppCompatActivity).supportActionBar?.getCustomView()!!.findViewById(R.id.app_title_tv) as TextView).text = "Lead"
